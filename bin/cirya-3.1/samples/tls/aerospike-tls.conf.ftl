...
network {
	...
	service {
		...
		# Configure tls access address and access port
		<#assign tlsHostPort=genericHelper.publicEndpoint(self, 3010)>
        tls-access-address ${tlsHostPort.host}
        tls-access-port ${tlsHostPort.port?c}
	}
